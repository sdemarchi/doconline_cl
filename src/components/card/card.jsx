...
export default function Card(props){
    ...
    return(
        <>
        {props.show !== false &&
        <div style={props.style} className={`card ${props.responsive ? 'card-resp' : ''} ${props.animate ? 'animation-card' : ''} ${props.onlyCel ? 'display-cel' : ''} ${props.onlyPc ? 'display-pc' : ''}`} ref={cardRef}>
