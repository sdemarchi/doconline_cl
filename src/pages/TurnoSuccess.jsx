...
function TurnoSuccess() {
    ...
    return (
        <>
            ...
            <h3 className='text-xl font-semibold text-center text-transparent bg-clip-text text-black'>Envianos el comprobante de pago por Whatsapp para evitar la cancelacion del turno.</h3>
